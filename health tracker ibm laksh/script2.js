...
function editRow(){
    ...
    heartrate[editIndex] = hInput.value
    fillTable()
    addToLocalStorage()
    cancelEdit()
}
...
${bloodsugar[i]}mg/dL,${heartrate[i]}bpm`)) 
return
    date.splice(i, 1)
    water.splice(i, 1)
    exercise.splice(i, 1)
    bloodsugar.splice(i, 1)
    heartrate.splice(i,1)
...
const hInput = document.getElementById("heartrate")
...
submitButton.addEventListener("click", ()=>{
    ...
    const h = hInput.value || null;
    if(w===null || e===null || b===null || h===null) {
